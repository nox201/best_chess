class Bishop extends Piece {
	...
	draw = function(row, column, squareSize){
		...
		if(this.colour == 'white'){
			this.plane.fillText('\u{2657}', squareSize * row + (squareSize / 2), squareSize * column + squareSize);
		}else{
			this.plane.fillText('\u{265D}', squareSize * row + (squareSize / 2), squareSize * column + squareSize);
		}
	}
